...
export default function EducationPage() {
  ...
  return (
    <div className="edu-container">
      <button
        className="edu-dashboard-button"
      ...
      <div className="edu-card">
        <div className="edu-alert-box">
          ...
          <p>
            No actual data was collected. This demonstration shows how phishing
        ...
        <div className="edu-content">
          <h3>What Happened?</h3>
          <p>
            You just interacted with a simulated phishing page. In a real
            attack, any credentials entered could have been compromised. This
            simulation was created for educational purposes to demonstrate
            common phishing techniques.
          </p>

          <h3>Phishing vs Legitimate Email</h3>
          <p>
            Learn to spot the differences between phishing attempts and
          ...
          <div className="email-comparison-grid">
            ...
            <div className="email-card phishing-email">
              ...
              <div className="email-body">
                ...
                <button className="email-button phishing-button">
                  Verify Account Now
                </button>
              </div>
              ...
              <div className="email-warnings">
                <div className="warning-item">
                  ...
                  <div>
                    ...
                    <span>Note the "1" instead of "l" in paypal</span>
                  </div>
                </div>
                <div className="warning-item">
                  <svg
                  ...
                  <div>
                    ...
                    <span>Threatens account suspension</span>
                  </div>
                </div>
                <div className="warning-item">
                  <svg
            ...
            <div className="email-card legitimate-email">
              ...
              <div className="email-body">
                ...
                <p>
                  Your monthly statement for account ending in 4523 is now
                  available. Log in to your account through our website or
                  mobile app to view it.
                </p>
                <p className="email-disclaimer">
                  This is an automated message. Please do not click links in
                  emails - always navigate to our website directly.
                </p>
              </div>
              ...
              <div className="email-checks">
                ...
                <div className="check-item">
                  ...
                  <div>
                    ...
                    <span>Uses your name and account details</span>
                  </div>
                </div>
                <div className="check-item">
                  <svg
                  ...
                  <div>
                    ...
                    <span>Informational, not urgent</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <ul>
            <li>
              <strong>Verify URLs:</strong> Always check that you're on the
              correct domain before entering credentials
            </li>
            <li>
              <strong>Use Multi-Factor Authentication:</strong> Adds an
              additional layer of security beyond passwords
            </li>
            <li>
              <strong>Avoid clicking email links:</strong> Navigate to websites
              directly by typing the URL
            </li>
            <li>
              <strong>Question urgency:</strong> Legitimate organizations rarely
              threaten immediate account closure
            </li>
            <li>
              <strong>Report suspicious activity:</strong> Forward phishing
          ...
          <div className="stats-grid">
            <div className="stat-item">
              <strong>73%</strong>
              <span>
                of adults have experienced online scams or phishing attempts
              </span>
            </div>
            <div className="stat-item">
              <strong>90%</strong>
          ...
          <div className="info-box">
            <h4>Remember</h4>
            <p>
              Always verify before you trust. Taking a moment to confirm the
              legitimacy of a request can prevent identity theft, financial
              loss, and unauthorized access to your accounts. When in doubt,
